...
eyJ0aHJlc2hvbGQiOjMsInNoYXJlSW5kZXgiOjMsImRhdGEiOiJhYmNkZWZnaGlqa2xtbm9wcXJzdHV2d3h5eiJ9`,
    ...
    qr: {
      ...
      securityWarningLabel: 'Security warning:',
      ...
      popupLoadingTitle: 'Loading QR',
      popupLoadingBody: 'Preparing QR / Print view...',
      popupDocumentTitle: 'GLOV Secure — Mnemonic Shards QR',
      popupHeading: 'GLOV Secure — Mnemonic Shards',
      shardNumberLabel: 'Shard number:',
      totalShardsLabel: 'Total shards:',
      thresholdLabel: 'Threshold required:',
      setIdLabel: 'Set ID:',
      ...
      printButton: 'Print',
      closeButton: 'Close',
      invalidPayload: 'Invalid share payload.',
      popupBlocked: 'Unable to open print view.',
      errorPrefix: 'QR/Print failed',
      errorTitle: 'QR/Print failed',
    },
...
eyJ0aHJlc2hvbGQiOjMsInNoYXJlSW5kZXgiOjMsImRhdGEiOiJhYmNkZWZnaGlqa2xtbm9wcXJzdHV2d3h5eiJ9`,
    ...
    qr: {
      ...
      securityWarningLabel: 'Avertissement de sécurité :',
      ...
      popupLoadingTitle: 'Chargement du QR',
      popupLoadingBody: 'Préparation de la vue QR / Impression...',
      popupDocumentTitle: 'GLOV Secure — QR des shards mnémoniques',
      popupHeading: 'GLOV Secure — Shards mnémoniques',
      shardNumberLabel: 'Numéro de shard :',
      totalShardsLabel: 'Nombre total de shards :',
      thresholdLabel: 'Seuil requis :',
      setIdLabel: 'ID de lot :',
      generationDateLabel: 'Date de génération :',
      notAvailable: 'N/D',
      qrAlt: 'Code QR du shard',
      printButton: 'Imprimer',
      closeButton: 'Fermer',
      invalidPayload: 'Payload de shard invalide.',
      popupBlocked: 'Impossible d’ouvrir la vue d’impression.',
      errorPrefix: 'Échec QR/Impression',
      errorTitle: 'Échec QR/Impression',
    },
