...
export const BIP39_WORDLIST = [
  ...
  'badge', 'badly', 'bag', 'balance', 'balcony', 'ball', 'bamboo', 'banana',
  ...
  'blanket', 'blast', 'bleak', 'bless', 'blind', 'blink', 'blood', 'blossom',
  'blouse', 'blue', 'blur', 'blush', 'board', 'boat', 'body', 'boil', 'bomb',
  'bone', 'bonus', 'book', 'boost', 'border', 'boring', 'borrow', 'boss', 'both',
  'bottle', 'bottom', 'boundary', 'box', 'bracket', 'brain', 'brand', 'brave',
  'bread', 'break', 'breast', 'breed', 'brick', 'bride', 'brief', 'bring',
  ...
  'carbon', 'card', 'cargo', 'carry', 'cart', 'case', 'cash', 'casino', 'castle',
  ...
  'charity', 'charm', 'chart', 'chase', 'cheap', 'check', 'cheese', 'chef',
  ...
  'cloud', 'cloudy', 'clown', 'club', 'clump', 'cluster', 'coach', 'coast', 'coconut',
  ...
  'cram', 'crane', 'crash', 'crawl', 'crazy', 'cream', 'credit', 'creek', 'crew',
  ...
  'double', 'doubt', 'down', 'dozen', 'draft', 'dragon', 'drama', 'drastic', 'draw',
  ...
  'exotic', 'expand', 'expect', 'expire', 'explain', 'explode', 'export', 'expose',
  'express', 'extend', 'exterior', 'extra', 'exotic', 'exult', 'fabric', 'face',
  ...
  'frame', 'frequent', 'fresh', 'friend', 'fridge', 'fringe', 'frog', 'front',
  'frost', 'frozen', 'fruit', 'fuel', 'fun', 'funny', 'furnace', 'fury', 'future',
  ...
  'grape', 'graph', 'grass', 'gratitude', 'grave', 'gray', 'great', 'green',
  ...
  'lawsuit', 'layer', 'lazy', 'leader', 'leaf', 'learn', 'lease', 'least', 'leather',
  'leave', 'lecture', 'left', 'leg', 'legal', 'lemon', 'lend', 'length', 'lens',
  ...
  'mad', 'magic', 'magnet', 'maid', 'mail', 'main', 'major', 'make', 'mammal',
  ...
  'name', 'napkin', 'narrow', 'nasty', 'nation', 'nature', 'near', 'neck', 'need',
  ...
  'olympic', 'once', 'one', 'onion', 'online', 'only', 'open', 'opera', 'opinion',
  ...
  'path', 'patient', 'patrol', 'pattern', 'pause', 'payment', 'peace', 'peanut',
  ...
  'plate', 'play', 'please', 'pledge', 'pluck', 'plug', 'plunge', 'poem', 'poet',
  ...
  'repeat', 'report', 'require', 'rescue', 'resemble', 'resist', 'resource', 'response',
  'result', 'retire', 'retreat', 'return', 'reunion', 'reveal', 'review', 'reward',
  'rhythm', 'rib', 'ribbon', 'rice', 'rich', 'ride', 'ridge', 'rifle', 'right',
  'rigid', 'ring', 'riot', 'ripple', 'risk', 'ritual', 'rival', 'river', 'road',
  'roast', 'robot', 'robust', 'rocket', 'romance', 'roof', 'rookie', 'room', 'rose',
  'rotate', 'rough', 'round', 'route', 'royal', 'rubber', 'rude', 'rug', 'rule',
  'run', 'runway', 'rural', 'sad', 'sadness', 'safe', 'sail', 'salad', 'salmon',
  'salon', 'salt', 'salute', 'same', 'sample', 'sand', 'satisfy', 'sauce', 'sausage',
  ...
  'sentence', 'series', 'service', 'session', 'setup', 'seven', 'shadow', 'shaft',
  'shallow', 'share', 'shed', 'shell', 'sheriff', 'shield', 'shift', 'shine',
  'ship', 'shiver', 'shock', 'shoe', 'shoot', 'shop', 'short', 'shoulder', 'shove',
  'shrimp', 'shrug', 'shuffle', 'shy', 'sibling', 'side', 'siege', 'sight',
  'silence', 'silk', 'silly', 'silver', 'similar', 'simple', 'since', 'sing',
  'siren', 'sister', 'site', 'situate', 'six', 'size', 'skate', 'sketch', 'ski',
  'skill', 'skin', 'skip', 'skull', 'slab', 'slam', 'sleep', 'slide', 'slight',
  'slim', 'slogan', 'slot', 'slow', 'slush', 'small', 'smart', 'smile', 'smoke',
  'smooth', 'snack', 'snake', 'snap', 'sniff', 'snow', 'soap', 'soccer', 'social',
  'sock', 'soda', 'solar', 'soldier', 'solid', 'solve', 'someone', 'song', 'soon',
  'sorry', 'sort', 'soul', 'sound', 'soup', 'source', 'south', 'space', 'spare',
  'spark', 'spatial', 'speak', 'special', 'speed', 'spell', 'spend', 'sphere',
  ...
  'suggest', 'suit', 'summer', 'sun', 'sunny', 'super', 'supply', 'supreme',
  'sure', 'surface', 'surge', 'surprise', 'surround', 'survey', 'suspect', 'sustain',
  'swallow', 'swap', 'swarm', 'swear', 'sweet', 'swift', 'swim', 'swing', 'switch',
  ...
  'this', 'thought', 'three', 'thrive', 'throw', 'thumb', 'thunder', 'ticket', 'tide',
  'tiger', 'tilt', 'timber', 'time', 'tiny', 'tip', 'tired', 'tissue', 'title',
  'toast', 'tobacco', 'today', 'toddler', 'toe', 'together', 'token', 'tomato',
  ...
  'typical', 'ugly', 'umbrella', 'unable', 'unusual', 'uncle', 'uncover', 'under',
  ...
  'useless', 'usual', 'utility', 'vacate', 'vacuum', 'vague', 'valid', 'valley',
  ...
  'vintage', 'violet', 'virtual', 'virus', 'visa', 'visit', 'visual', 'vital',
  'vivid', 'vocal', 'voice', 'void', 'volcano', 'volume', 'vote', 'voyage', 'wage',
  'wagon', 'wait', 'walk', 'wall', 'want', 'warehouse', 'warrior', 'wash', 'wasp',
  'waste', 'water', 'wave', 'way', 'wealth', 'weapon', 'wear', 'weasel', 'weather',
  'web', 'wedding', 'weekend', 'weird', 'welcome', 'west', 'whale', 'what', 'wheat',
